...
//     const Op = Sequelize.Op;
//     return queryInterface.bulkDelete(options, {
//       name: { [Op.in]: ['The Royce Home', 'Tara Mansion', 'The Adrian Estate', 'Architectural wonder in the woods', 'LaGalleria', 'Ala Moana', 'Waterfront. Private beach. Heated Pool.', 'Le Mica', 'The Catskill A-Frame', 'Chalet in the Clouds', 'Paradise in York', 'The A-Frame at Harvest Moon Acres', 'Mediterranean Mansion by the Sea', 'Oceanfront Paradise', 'The Majestic Mountain Retreat', 'Payson Perfection', 'Hidden Harbor', 'Noku Beach House'] }
//     }, {});
//   }
// };
